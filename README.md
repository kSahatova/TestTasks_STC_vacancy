...
![\Large \beta=[A'{\ast}A]^{-1}{\ast}A'{\ast}y](https://latex.codecogs.com/svg.latex?\Large&space;\beta=[A'{\ast}A]^{-1}{\ast}A'{\ast}y)  

где ![\Large \beta](https://latex.codecogs.com/svg.latex?\beta&space;) — вектор оценок параметров,  
![\Large A](https://latex.codecogs.com/svg.latex?A&space;) — матрица, составленная из входных значений на объект,   
![\Large y](https://latex.codecogs.com/svg.latex?y&space;) — выходные значения.
